<?php
class FileUpload {
    private $destino="./", $nombre="as", $tamaño=1000000000000000000000000000, $parametro;
    ...
    public function upload(){
        ...
        var_dump($_FILES[$this->parametro]);
        if($this->error){
            return false;
        }
        ...
        //if($_FILES[$this->parametro]["error"]!=UPLOAD_ERR_OK){
         //   return false;
        //}
       echo $this->isTipo($this->extension);
        ...
        if($this->politica === self::RENOMBRAR
         ...
         echo $_FILES[$this->parametro]["tmp_name"];
