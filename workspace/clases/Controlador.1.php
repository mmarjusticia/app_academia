...
//nombre del archivo eliminando cualquier ruta.
    ...
    function metodophpAltaAlumno(){
        ...
        if(count($listaAlumnosPorTlf)<1){
            ...
            $datos = array(
                "mensaje" => "El alumno ha sido introducido exitosamente y su contraseña es $clave",
    ...
    /*------------profesor-------------*/
     ...
     function metodoPhpSubirArchivos(){
        ...
        $palabra=$this->sesion->get('_palabra');
         ...
         $nombre=$profesor->getNombre();echo $nombre;
         $telefono=$profesor->getTelefono();echo$telefono;
         $materia=Request::post('materia');echo $materia;
         $curso=Request::post('curso');
